...
type ProxmoxConfig struct {
	...
	RNGSource   string `yaml:"rngSource,omitempty"` // e.g., "/dev/urandom"
...
func WithProxmoxRNGSource(source string) MachineOption {
	return func(mc *MachineConfig) error {
		if mc.Proxmox == nil {
			mc.Proxmox = &ProxmoxConfig{}
		}
		if source != "" {
			mc.Proxmox.RNGSource = source
		}
		return nil
	}
}
...
func WithProxmoxInsecureTLS(insecure bool) MachineOption {
	return func(mc *MachineConfig) error {
		if mc.Proxmox == nil {
			mc.Proxmox = &ProxmoxConfig{}
		}
		mc.Proxmox.InsecureTLS = insecure
		return nil
	}
}
